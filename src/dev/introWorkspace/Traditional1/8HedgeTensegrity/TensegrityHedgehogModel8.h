...
#ifndef TENSEGRITY_HEDGEHOGMODEL8_H
#define TENSEGRITY_HEDGEHOGMODEL8_H
 ...
 */
class TensegrityHedgehogModel8 : public tgSubject<TensegrityHedgehogModel8>, public tgModel
{
public: 
     ...
     * not passed in. 
     */
    TensegrityHedgehogModel8();
	
	/**
     * Function introduved to centrate the Hedgehog
     */
    TensegrityHedgehogModel8(btVector3 origin);
    /**
     * Destructor. Deletes controllers, if any were added during setup.
     * Teardown handles everything else.
     */
    virtual ~TensegrityHedgehogModel8();
...
#endif  // TENSEGRITY_HEDGEHOGMODEL8_H
